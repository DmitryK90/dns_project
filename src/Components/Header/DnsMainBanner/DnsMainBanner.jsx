    ...
    <div className={style.burger_catalog}>
      <div className={style.dns_banner}>
        ...
        <div className={style.btn_catalog}>
          ...
          {/* <img src={down_caret} className={style.down_caret} alt="" /> */}
        </div>
      </div>
    </div>
  );
